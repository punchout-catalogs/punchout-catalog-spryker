...
namespace PunchoutCatalog\Zed\PunchoutCatalogDataImport\Communication\Plugin;
...
/**
 * @method \PunchoutCatalog\Zed\PunchoutCatalogDataImport\Business\PunchoutCatalogDataImportFacadeInterface getFacade()
...
class PunchoutCatalogConnectionDataImportPlugin extends AbstractPlugin implements DataImportPluginInterface
{
    ...
    {
        return PunchoutCatalogDataImportConfig::IMPORT_TYPE_PUNCHOUT_CATALOG_CONNECTION;
    }
}
