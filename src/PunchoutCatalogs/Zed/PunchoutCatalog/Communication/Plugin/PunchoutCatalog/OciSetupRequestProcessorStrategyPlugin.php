...
use PunchoutCatalogs\Zed\PunchoutCatalog\Business\Mapping\Oci\Decoder;
use PunchoutCatalogs\Zed\PunchoutCatalog\Business\PunchoutConnectionConstsInterface;
use PunchoutCatalogs\Zed\PunchoutCatalogExtension\Dependency\Plugin\PunchoutCatalogRequestProcessorStrategyPluginInterface;
...
class OciSetupRequestProcessorStrategyPlugin extends AbstractSetupRequestProcessorStrategyPlugin implements PunchoutCatalogRequestProcessorStrategyPluginInterface
{
    ...
    protected function decode(PunchoutCatalogRequestTransfer $punchoutCatalogRequestTransfer): array
    {
        ...
        $mappingTransfer = $this->convertToMappingTransfer(
            (string)$punchoutCatalogRequestTransfer->getPunchoutCatalogConnection()->getMappingRequest()
        );
