...
namespace PunchoutCatalogs\Client\PunchoutCatalog\Dependency\Client;

use Spryker\Shared\Kernel\Transfer\TransferInterface;

class PunchoutCatalogToZedRequestClientBridge implements PunchoutCatalogToZedRequestClientInterface
{
    /**
